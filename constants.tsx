...
export const INTEREST_OPTIONS = [
  "History", "Art & Culture", "Food & Culinary", "Adventure & Outdoors",
  "Relaxation & Wellness", "Family Friendly", "Nightlife", "Shopping",
  "Nature & Wildlife", "Technology & Science"
];

export const BUDGET_OPTIONS = ["Budget-Friendly", "Mid-Range", "Luxury"];
export const GROUP_COMPOSITION_OPTIONS = ["Solo", "Couple", "Family with kids", "Group of friends"];
export const EXPERIENCE_OPTIONS = ["First-timer", "Returning visitor"];
export const ATTRACTION_TYPE_OPTIONS = ["Popular attractions", "Local hidden gems", "A mix of both"];
...
export const BedIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v13m0-13V6a2 2 0 114 0v2m-4 0H8a2 2 0 100 4h4V8z" />
    </svg>
);
...
export const GroqIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 16 16">
        <path fill="currentColor" fillRule="evenodd" d="M10.854 8.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 0 1 .708-.708L7.5 10.793l2.646-2.647a.5.5 0 0 1 .708 0z" />
...
export const BriefcaseIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 13.255V19a2 2 0 002 2h10a2 2 0 002-2v-5.745" />
    </svg>
);

export const MapIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l5.447 2.724A1 1 0 0021 16.382V5.618a1 1 0 00-1.447-.894L15 7m-6 10V7m0 0l6-3m0 0l6 3m-6-3v10" />
    </svg>
);
